...
from . import options as msm_options  # rename due to a name conflict with World.options
from .locations import MSMLocation
...
class MSMWorld(World):
    ...
    web = web_world.MSMWebWorld()

    # This is how we associate the options defined in our options.py with our world.
    # (Note: options.py has been imported as "msm_options" at the top of this file to avoid a name conflict)
    options_dataclass = msm_options.MSMOptions
    options: msm_options.MSMOptions  # Common mistake: This has to be a colon (:), not an equals sign (=).
