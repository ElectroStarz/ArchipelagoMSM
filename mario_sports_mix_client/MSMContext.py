...
class MSMContext(SuperContext):
    ...
    def on_package(self, cmd: str, args: dict):
        ...
        if cmd == "Connected":
            ...
            self.send_both_character_sanity = self.slot_data.get("send_both_character_sanity", False)
            self.court_sanity = self.slot_data.get("court_sanity", False)
            self.special_sanity = self.slot_data.get("special_sanity", False)
