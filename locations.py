...
global_exhibition_locations: Dict[str, LocData] = {
    ...
    "Exhibition: Beat Western Junction (Easy)":        LocData(base_id + 604, LocGroup.EXHIBITION_EASY),
    "Exhibition: Beat Wario Factory (Easy)":           LocData(base_id + 605, LocGroup.EXHIBITION_EASY),
    "Exhibition: Beat Daisy Garden (Easy)":            LocData(base_id + 606, LocGroup.EXHIBITION_EASY),
    "Exhibition: Beat Bowser Jr. Blvd. (Easy)":        LocData(base_id + 607, LocGroup.EXHIBITION_EASY),
    "Exhibition: Beat Waluigi Pinball (Easy)":         LocData(base_id + 608, LocGroup.EXHIBITION_EASY),
    "Exhibition: Beat Star Ship (Easy)":               LocData(base_id + 609, LocGroup.EXHIBITION_EASY),
    "Exhibition: Beat Koopa Troopa Beach (Easy)":      LocData(base_id + 610, LocGroup.EXHIBITION_EASY),
    "Exhibition: Beat Ghoulish Galleon (Easy)":        LocData(base_id + 611, LocGroup.EXHIBITION_EASY),
    "Exhibition: Beat Bowser's Castle (Easy)":         LocData(base_id + 612, LocGroup.EXHIBITION_EASY),

    # Normal
    "Exhibition: Beat Mario Stadium (Normal)":         LocData(base_id + 613, LocGroup.EXHIBITION_NORMAL),
    "Exhibition: Beat Toad Park (Normal)":             LocData(base_id + 614, LocGroup.EXHIBITION_NORMAL),
    "Exhibition: Beat Peach's Castle (Normal)":        LocData(base_id + 615, LocGroup.EXHIBITION_NORMAL),
    "Exhibition: Beat DK Dock (Normal)":               LocData(base_id + 616, LocGroup.EXHIBITION_NORMAL),
    "Exhibition: Beat Western Junction (Normal)":      LocData(base_id + 617, LocGroup.EXHIBITION_NORMAL),
    "Exhibition: Beat Wario Factory (Normal)":         LocData(base_id + 618, LocGroup.EXHIBITION_NORMAL),
    "Exhibition: Beat Daisy Garden (Normal)":          LocData(base_id + 619, LocGroup.EXHIBITION_NORMAL),
    "Exhibition: Beat Bowser Jr. Blvd. (Normal)":      LocData(base_id + 620, LocGroup.EXHIBITION_NORMAL),
    "Exhibition: Beat Waluigi Pinball (Normal)":       LocData(base_id + 621, LocGroup.EXHIBITION_NORMAL),
    "Exhibition: Beat Star Ship (Normal)":             LocData(base_id + 622, LocGroup.EXHIBITION_NORMAL),
    "Exhibition: Beat Koopa Troopa Beach (Normal)":    LocData(base_id + 623, LocGroup.EXHIBITION_NORMAL),
    "Exhibition: Beat Ghoulish Galleon (Normal)":      LocData(base_id + 624, LocGroup.EXHIBITION_NORMAL),
    "Exhibition: Beat Bowser's Castle (Normal)":       LocData(base_id + 625, LocGroup.EXHIBITION_NORMAL),

    # Hard
    "Exhibition: Beat Mario Stadium (Hard)":           LocData(base_id + 626, LocGroup.EXHIBITION_HARD),
    "Exhibition: Beat Toad Park (Hard)":               LocData(base_id + 627, LocGroup.EXHIBITION_HARD),
    "Exhibition: Beat Peach's Castle (Hard)":          LocData(base_id + 628, LocGroup.EXHIBITION_HARD),
    "Exhibition: Beat DK Dock (Hard)":                 LocData(base_id + 629, LocGroup.EXHIBITION_HARD),
    "Exhibition: Beat Western Junction (Hard)":        LocData(base_id + 630, LocGroup.EXHIBITION_HARD),
    "Exhibition: Beat Wario Factory (Hard)":           LocData(base_id + 631, LocGroup.EXHIBITION_HARD),
    "Exhibition: Beat Daisy Garden (Hard)":            LocData(base_id + 632, LocGroup.EXHIBITION_HARD),
    "Exhibition: Beat Bowser Jr. Blvd. (Hard)":        LocData(base_id + 633, LocGroup.EXHIBITION_HARD),
    "Exhibition: Beat Waluigi Pinball (Hard)":         LocData(base_id + 634, LocGroup.EXHIBITION_HARD),
    "Exhibition: Beat Star Ship (Hard)":               LocData(base_id + 635, LocGroup.EXHIBITION_HARD),
    "Exhibition: Beat Koopa Troopa Beach (Hard)":      LocData(base_id + 636, LocGroup.EXHIBITION_HARD),
    "Exhibition: Beat Ghoulish Galleon (Hard)":        LocData(base_id + 637, LocGroup.EXHIBITION_HARD),
    "Exhibition: Beat Bowser's Castle (Hard)":         LocData(base_id + 638, LocGroup.EXHIBITION_HARD),

    # Expert
    "Exhibition: Beat Mario Stadium (Expert)":         LocData(base_id + 639, LocGroup.EXHIBITION_EXPERT),
    "Exhibition: Beat Toad Park (Expert)":             LocData(base_id + 640, LocGroup.EXHIBITION_EXPERT),
    "Exhibition: Beat Peach's Castle (Expert)":        LocData(base_id + 641, LocGroup.EXHIBITION_EXPERT),
    "Exhibition: Beat DK Dock (Expert)":               LocData(base_id + 642, LocGroup.EXHIBITION_EXPERT),
    "Exhibition: Beat Western Junction (Expert)":      LocData(base_id + 643, LocGroup.EXHIBITION_EXPERT),
    "Exhibition: Beat Wario Factory (Expert)":         LocData(base_id + 644, LocGroup.EXHIBITION_EXPERT),
    "Exhibition: Beat Daisy Garden (Expert)":          LocData(base_id + 645, LocGroup.EXHIBITION_EXPERT),
    "Exhibition: Beat Bowser Jr. Blvd. (Expert)":      LocData(base_id + 646, LocGroup.EXHIBITION_EXPERT),
    "Exhibition: Beat Waluigi Pinball (Expert)":       LocData(base_id + 647, LocGroup.EXHIBITION_EXPERT),
    "Exhibition: Beat Star Ship (Expert)":             LocData(base_id + 648, LocGroup.EXHIBITION_EXPERT),
    "Exhibition: Beat Koopa Troopa Beach (Expert)":    LocData(base_id + 649, LocGroup.EXHIBITION_EXPERT),
    "Exhibition: Beat Ghoulish Galleon (Expert)":      LocData(base_id + 650, LocGroup.EXHIBITION_EXPERT),
    "Exhibition: Beat Bowser's Castle (Expert)":       LocData(base_id + 651, LocGroup.EXHIBITION_EXPERT),
}
