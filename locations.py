...
basketball_alternate_path_normal_locations: Dict[str, LocData] = {
    ...
    "Basketball Mushroom Cup Alt Path Normal By Castle Flowers": LocData(base_id + 30005,
                                                                         LocGroup.BASKETBALL_ALT_NORMAL),
    ...
    "Basketball Mushroom Cup Alt Path Normal Top of the Mountain": LocData(base_id + 30011,
                                                                           LocGroup.BASKETBALL_ALT_NORMAL),
    "Basketball Mushroom Cup Alt Path Normal Upper Field": LocData(base_id + 30012, LocGroup.BASKETBALL_ALT_NORMAL),
    "Basketball Mushroom Cup Alt Path Normal Near Green Toad House": LocData(base_id + 30013,
                                                                             LocGroup.BASKETBALL_ALT_NORMAL),
    ...
    "Basketball Flower Cup Alt Path Normal Left-Center Bridge": LocData(base_id + 30048,
                                                                        LocGroup.BASKETBALL_ALT_NORMAL),
    "Basketball Flower Cup Alt Path Normal Flower Lake Island": LocData(base_id + 30049,
                                                                        LocGroup.BASKETBALL_ALT_NORMAL),
    ...
    "Basketball Flower Cup Alt Path Normal Bottom-Left Island House": LocData(base_id + 30052,
                                                                              LocGroup.BASKETBALL_ALT_NORMAL),
    "Basketball Flower Cup Alt Path Normal Bottom-Left Island Cannon": LocData(base_id + 30053,
                                                                               LocGroup.BASKETBALL_ALT_NORMAL),
    "Basketball Flower Cup Alt Path Normal Bottom-Right Island": LocData(base_id + 30054,
                                                                         LocGroup.BASKETBALL_ALT_NORMAL),
    "Basketball Flower Cup Alt Path Normal Middle-Left Islands": LocData(base_id + 30055,
                                                                         LocGroup.BASKETBALL_ALT_NORMAL),
    ...
    "Basketball Flower Cup Alt Path Normal Below Rightmost Bridge": LocData(base_id + 30059,
                                                                            LocGroup.BASKETBALL_ALT_NORMAL),
    "Basketball Flower Cup Alt Path Normal Above Rightmost Bridge": LocData(base_id + 30060,
                                                                            LocGroup.BASKETBALL_ALT_NORMAL),
    "Basketball Flower Cup Alt Path Normal Middle-Right Island Field": LocData(base_id + 30061,
                                                                               LocGroup.BASKETBALL_ALT_NORMAL),
    "Basketball Flower Cup Alt Path Normal Middle-Right Island Cannon": LocData(base_id + 30062,
                                                                                LocGroup.BASKETBALL_ALT_NORMAL),
    "Basketball Flower Cup Alt Path Normal Top-Right Island Tower": LocData(base_id + 30063,
                                                                            LocGroup.BASKETBALL_ALT_NORMAL),
    "Basketball Flower Cup Alt Path Normal Top-Right Island Bottom Field": LocData(base_id + 30064,
                                                                                   LocGroup.BASKETBALL_ALT_NORMAL),
    "Basketball Flower Cup Alt Path Normal Top-Right Island Right Field": LocData(base_id + 30065,
                                                                                  LocGroup.BASKETBALL_ALT_NORMAL),
    ...
    "Basketball Star Cup Alt Path Normal Star Road (Left) Intro": LocData(base_id + 30121,
                                                                          LocGroup.BASKETBALL_ALT_NORMAL),
    "Basketball Star Cup Alt Path Normal Star Road (Left) Bonus": LocData(base_id + 30122,
                                                                          LocGroup.BASKETBALL_ALT_NORMAL),
    "Basketball Star Cup Alt Path Normal Star Road (Right) Intro": LocData(base_id + 30123,
                                                                           LocGroup.BASKETBALL_ALT_NORMAL),
    "Basketball Star Cup Alt Path Normal Star Road (Right) Bonus": LocData(base_id + 30124,
                                                                           LocGroup.BASKETBALL_ALT_NORMAL),
    "Basketball Star Cup Alt Path Normal Star Road Bottom-Left of Star": LocData(base_id + 30125,
                                                                                 LocGroup.BASKETBALL_ALT_NORMAL),
    "Basketball Star Cup Alt Path Normal Star Road Top-Left of Star": LocData(base_id + 30126,
                                                                              LocGroup.BASKETBALL_ALT_NORMAL),
    "Basketball Star Cup Alt Path Normal Star Road Top-Center of Star": LocData(base_id + 30127,
                                                                                LocGroup.BASKETBALL_ALT_NORMAL),
    "Basketball Star Cup Alt Path Normal Star Road Top-Right of Star": LocData(base_id + 30128,
                                                                               LocGroup.BASKETBALL_ALT_NORMAL),
    "Basketball Star Cup Alt Path Normal Star Road Bottom-Right of Star": LocData(base_id + 30129,
                                                                                  LocGroup.BASKETBALL_ALT_NORMAL),
}

basketball_alternate_path_hard_locations: Dict[str, LocData] = {
    "Basketball Mushroom Cup Alt Path Hard East of Red Toad House": LocData(base_id + 30016,
                                                                            LocGroup.BASKETBALL_ALT_HARD),
    ...
    "Basketball Mushroom Cup Alt Path Hard Near Green Toad House": LocData(base_id + 30029,
                                                                           LocGroup.BASKETBALL_ALT_HARD),
    ...
    "Basketball Flower Cup Alt Path Hard Bottom-Left Island House": LocData(base_id + 30071,
                                                                            LocGroup.BASKETBALL_ALT_HARD),
    "Basketball Flower Cup Alt Path Hard Bottom-Left Island Cannon": LocData(base_id + 30072,
                                                                             LocGroup.BASKETBALL_ALT_HARD),
    ...
    "Basketball Flower Cup Alt Path Hard Below Rightmost Bridge": LocData(base_id + 30078,
                                                                          LocGroup.BASKETBALL_ALT_HARD),
    "Basketball Flower Cup Alt Path Hard Above Rightmost Bridge": LocData(base_id + 30079,
                                                                          LocGroup.BASKETBALL_ALT_HARD),
    "Basketball Flower Cup Alt Path Hard Middle-Right Island Field": LocData(base_id + 30080,
                                                                             LocGroup.BASKETBALL_ALT_HARD),
    "Basketball Flower Cup Alt Path Hard Middle-Right Island Cannon": LocData(base_id + 30081,
                                                                              LocGroup.BASKETBALL_ALT_HARD),
    "Basketball Flower Cup Alt Path Hard Top-Right Island Tower": LocData(base_id + 30082,
                                                                          LocGroup.BASKETBALL_ALT_HARD),
    "Basketball Flower Cup Alt Path Hard Top-Right Island Bottom Field": LocData(base_id + 30083,
                                                                                 LocGroup.BASKETBALL_ALT_HARD),
    "Basketball Flower Cup Alt Path Hard Top-Right Island Right Field": LocData(base_id + 30084,
                                                                                LocGroup.BASKETBALL_ALT_HARD),
    ...
    "Basketball Star Cup Alt Path Hard Star Road Bottom-Left of Star": LocData(base_id + 30150,
                                                                               LocGroup.BASKETBALL_ALT_HARD),
    "Basketball Star Cup Alt Path Hard Star Road Top-Left of Star": LocData(base_id + 30151,
                                                                            LocGroup.BASKETBALL_ALT_HARD),
    "Basketball Star Cup Alt Path Hard Star Road Top-Center of Star": LocData(base_id + 30152,
                                                                              LocGroup.BASKETBALL_ALT_HARD),
    "Basketball Star Cup Alt Path Hard Star Road Top-Right of Star": LocData(base_id + 30153,
                                                                             LocGroup.BASKETBALL_ALT_HARD),
    "Basketball Star Cup Alt Path Hard Star Road Bottom-Right of Star": LocData(base_id + 30154,
                                                                                LocGroup.BASKETBALL_ALT_HARD),
}
...
dodgeball_alternate_path_normal_locations: Dict[str, LocData] = {
    "Dodgeball Mushroom Cup Alt Path Normal East of Red Toad House": LocData(base_id + 30180,
                                                                             LocGroup.DODGEBALL_ALT_NORMAL),
    ...
    "Dodgeball Mushroom Cup Alt Path Normal Top of the Mountain": LocData(base_id + 30191,
                                                                          LocGroup.DODGEBALL_ALT_NORMAL),
    "Dodgeball Mushroom Cup Alt Path Normal Upper Field": LocData(base_id + 30192, LocGroup.DODGEBALL_ALT_NORMAL),
    "Dodgeball Mushroom Cup Alt Path Normal Near Green Toad House": LocData(base_id + 30193,
                                                                            LocGroup.DODGEBALL_ALT_NORMAL),
    ...
    "Dodgeball Flower Cup Alt Path Normal Bottom-Left Island House": LocData(base_id + 30232,
                                                                             LocGroup.DODGEBALL_ALT_NORMAL),
    "Dodgeball Flower Cup Alt Path Normal Bottom-Left Island Cannon": LocData(base_id + 30233,
                                                                              LocGroup.DODGEBALL_ALT_NORMAL),
    ...
    "Dodgeball Flower Cup Alt Path Normal Below Rightmost Bridge": LocData(base_id + 30239,
                                                                           LocGroup.DODGEBALL_ALT_NORMAL),
    "Dodgeball Flower Cup Alt Path Normal Above Rightmost Bridge": LocData(base_id + 30240,
                                                                           LocGroup.DODGEBALL_ALT_NORMAL),
    "Dodgeball Flower Cup Alt Path Normal Middle-Right Island Field": LocData(base_id + 30241,
                                                                              LocGroup.DODGEBALL_ALT_NORMAL),
    "Dodgeball Flower Cup Alt Path Normal Middle-Right Island Cannon": LocData(base_id + 30242,
                                                                               LocGroup.DODGEBALL_ALT_NORMAL),
    "Dodgeball Flower Cup Alt Path Normal Top-Right Island Tower": LocData(base_id + 30243,
                                                                           LocGroup.DODGEBALL_ALT_NORMAL),
    "Dodgeball Flower Cup Alt Path Normal Top-Right Island Bottom Field": LocData(base_id + 30244,
                                                                                  LocGroup.DODGEBALL_ALT_NORMAL),
    "Dodgeball Flower Cup Alt Path Normal Top-Right Island Right Field": LocData(base_id + 30245,
                                                                                 LocGroup.DODGEBALL_ALT_NORMAL),
    ...
    "Dodgeball Star Cup Alt Path Normal Star Road (Left) Intro": LocData(base_id + 30301,
                                                                         LocGroup.DODGEBALL_ALT_NORMAL),
    "Dodgeball Star Cup Alt Path Normal Star Road (Left) Bonus": LocData(base_id + 30302,
                                                                         LocGroup.DODGEBALL_ALT_NORMAL),
    "Dodgeball Star Cup Alt Path Normal Star Road (Right) Intro": LocData(base_id + 30303,
                                                                          LocGroup.DODGEBALL_ALT_NORMAL),
    "Dodgeball Star Cup Alt Path Normal Star Road (Right) Bonus": LocData(base_id + 30304,
                                                                          LocGroup.DODGEBALL_ALT_NORMAL),
    "Dodgeball Star Cup Alt Path Normal Star Road Bottom-Left of Star": LocData(base_id + 30305,
                                                                                LocGroup.DODGEBALL_ALT_NORMAL),
    "Dodgeball Star Cup Alt Path Normal Star Road Top-Left of Star": LocData(base_id + 30306,
                                                                             LocGroup.DODGEBALL_ALT_NORMAL),
    "Dodgeball Star Cup Alt Path Normal Star Road Top-Center of Star": LocData(base_id + 30307,
                                                                               LocGroup.DODGEBALL_ALT_NORMAL),
    "Dodgeball Star Cup Alt Path Normal Star Road Top-Right of Star": LocData(base_id + 30308,
                                                                              LocGroup.DODGEBALL_ALT_NORMAL),
    "Dodgeball Star Cup Alt Path Normal Star Road Bottom-Right of Star": LocData(base_id + 30309,
                                                                                 LocGroup.DODGEBALL_ALT_NORMAL),
}

dodgeball_alternate_path_hard_locations: Dict[str, LocData] = {
    "Dodgeball Mushroom Cup Alt Path Hard East of Red Toad House": LocData(base_id + 30196,
                                                                           LocGroup.DODGEBALL_ALT_HARD),
    ...
    "Dodgeball Flower Cup Alt Path Hard Bottom-Left Island House": LocData(base_id + 30251,
                                                                           LocGroup.DODGEBALL_ALT_HARD),
    "Dodgeball Flower Cup Alt Path Hard Bottom-Left Island Cannon": LocData(base_id + 30252,
                                                                            LocGroup.DODGEBALL_ALT_HARD),
    ...
    "Dodgeball Flower Cup Alt Path Hard Middle-Right Island Field": LocData(base_id + 30260,
                                                                            LocGroup.DODGEBALL_ALT_HARD),
    "Dodgeball Flower Cup Alt Path Hard Middle-Right Island Cannon": LocData(base_id + 30261,
                                                                             LocGroup.DODGEBALL_ALT_HARD),
    "Dodgeball Flower Cup Alt Path Hard Top-Right Island Tower": LocData(base_id + 30262, LocGroup.DODGEBALL_ALT_HARD),
    "Dodgeball Flower Cup Alt Path Hard Top-Right Island Bottom Field": LocData(base_id + 30263,
                                                                                LocGroup.DODGEBALL_ALT_HARD),
    "Dodgeball Flower Cup Alt Path Hard Top-Right Island Right Field": LocData(base_id + 30264,
                                                                               LocGroup.DODGEBALL_ALT_HARD),
    ...
    "Dodgeball Star Cup Alt Path Hard Star Road Bottom-Left of Star": LocData(base_id + 30330,
                                                                              LocGroup.DODGEBALL_ALT_HARD),
    "Dodgeball Star Cup Alt Path Hard Star Road Top-Left of Star": LocData(base_id + 30331,
                                                                           LocGroup.DODGEBALL_ALT_HARD),
    "Dodgeball Star Cup Alt Path Hard Star Road Top-Center of Star": LocData(base_id + 30332,
                                                                             LocGroup.DODGEBALL_ALT_HARD),
    "Dodgeball Star Cup Alt Path Hard Star Road Top-Right of Star": LocData(base_id + 30333,
                                                                            LocGroup.DODGEBALL_ALT_HARD),
    "Dodgeball Star Cup Alt Path Hard Star Road Bottom-Right of Star": LocData(base_id + 30334,
                                                                               LocGroup.DODGEBALL_ALT_HARD),
}
...
volleyball_alternate_path_normal_locations: Dict[str, LocData] = {
    "Volleyball Mushroom Cup Alt Path Normal East of Red Toad House": LocData(base_id + 30360,
                                                                              LocGroup.VOLLEYBALL_ALT_NORMAL),
    ...
    "Volleyball Mushroom Cup Alt Path Normal By Castle Flowers": LocData(base_id + 30365,
                                                                         LocGroup.VOLLEYBALL_ALT_NORMAL),
    ...
    "Volleyball Mushroom Cup Alt Path Normal Top of the Mountain": LocData(base_id + 30371,
                                                                           LocGroup.VOLLEYBALL_ALT_NORMAL),
    "Volleyball Mushroom Cup Alt Path Normal Upper Field": LocData(base_id + 30372, LocGroup.VOLLEYBALL_ALT_NORMAL),
    "Volleyball Mushroom Cup Alt Path Normal Near Green Toad House": LocData(base_id + 30373,
                                                                             LocGroup.VOLLEYBALL_ALT_NORMAL),
    ...
    "Volleyball Flower Cup Alt Path Normal Left-Center Bridge": LocData(base_id + 30408,
                                                                        LocGroup.VOLLEYBALL_ALT_NORMAL),
    "Volleyball Flower Cup Alt Path Normal Flower Lake Island": LocData(base_id + 30409,
                                                                        LocGroup.VOLLEYBALL_ALT_NORMAL),
    ...
    "Volleyball Flower Cup Alt Path Normal Bottom-Left Island House": LocData(base_id + 30412,
                                                                              LocGroup.VOLLEYBALL_ALT_NORMAL),
    "Volleyball Flower Cup Alt Path Normal Bottom-Left Island Cannon": LocData(base_id + 30413,
                                                                               LocGroup.VOLLEYBALL_ALT_NORMAL),
    "Volleyball Flower Cup Alt Path Normal Bottom-Right Island": LocData(base_id + 30414,
                                                                         LocGroup.VOLLEYBALL_ALT_NORMAL),
    "Volleyball Flower Cup Alt Path Normal Middle-Left Islands": LocData(base_id + 30415,
                                                                         LocGroup.VOLLEYBALL_ALT_NORMAL),
    ...
    "Volleyball Flower Cup Alt Path Normal Below Rightmost Bridge": LocData(base_id + 30419,
                                                                            LocGroup.VOLLEYBALL_ALT_NORMAL),
    "Volleyball Flower Cup Alt Path Normal Above Rightmost Bridge": LocData(base_id + 30420,
                                                                            LocGroup.VOLLEYBALL_ALT_NORMAL),
    "Volleyball Flower Cup Alt Path Normal Middle-Right Island Field": LocData(base_id + 30421,
                                                                               LocGroup.VOLLEYBALL_ALT_NORMAL),
    "Volleyball Flower Cup Alt Path Normal Middle-Right Island Cannon": LocData(base_id + 30422,
                                                                                LocGroup.VOLLEYBALL_ALT_NORMAL),
    "Volleyball Flower Cup Alt Path Normal Top-Right Island Tower": LocData(base_id + 30423,
                                                                            LocGroup.VOLLEYBALL_ALT_NORMAL),
    "Volleyball Flower Cup Alt Path Normal Top-Right Island Bottom Field": LocData(base_id + 30424,
                                                                                   LocGroup.VOLLEYBALL_ALT_NORMAL),
    "Volleyball Flower Cup Alt Path Normal Top-Right Island Right Field": LocData(base_id + 30425,
                                                                                  LocGroup.VOLLEYBALL_ALT_NORMAL),
    ...
    "Volleyball Star Cup Alt Path Normal Star Road (Left) Intro": LocData(base_id + 30481,
                                                                          LocGroup.VOLLEYBALL_ALT_NORMAL),
    "Volleyball Star Cup Alt Path Normal Star Road (Left) Bonus": LocData(base_id + 30482,
                                                                          LocGroup.VOLLEYBALL_ALT_NORMAL),
    "Volleyball Star Cup Alt Path Normal Star Road (Right) Intro": LocData(base_id + 30483,
                                                                           LocGroup.VOLLEYBALL_ALT_NORMAL),
    "Volleyball Star Cup Alt Path Normal Star Road (Right) Bonus": LocData(base_id + 30484,
                                                                           LocGroup.VOLLEYBALL_ALT_NORMAL),
    "Volleyball Star Cup Alt Path Normal Star Road Bottom-Left of Star": LocData(base_id + 30485,
                                                                                 LocGroup.VOLLEYBALL_ALT_NORMAL),
    "Volleyball Star Cup Alt Path Normal Star Road Top-Left of Star": LocData(base_id + 30486,
                                                                              LocGroup.VOLLEYBALL_ALT_NORMAL),
    "Volleyball Star Cup Alt Path Normal Star Road Top-Center of Star": LocData(base_id + 30487,
                                                                                LocGroup.VOLLEYBALL_ALT_NORMAL),
    "Volleyball Star Cup Alt Path Normal Star Road Top-Right of Star": LocData(base_id + 30488,
                                                                               LocGroup.VOLLEYBALL_ALT_NORMAL),
    "Volleyball Star Cup Alt Path Normal Star Road Bottom-Right of Star": LocData(base_id + 30489,
                                                                                  LocGroup.VOLLEYBALL_ALT_NORMAL),
}

volleyball_alternate_path_hard_locations: Dict[str, LocData] = {
    "Volleyball Mushroom Cup Alt Path Hard East of Red Toad House": LocData(base_id + 30376,
                                                                            LocGroup.VOLLEYBALL_ALT_HARD),
    ...
    "Volleyball Mushroom Cup Alt Path Hard Near Green Toad House": LocData(base_id + 30389,
                                                                           LocGroup.VOLLEYBALL_ALT_HARD),
    ...
    "Volleyball Flower Cup Alt Path Hard Bottom-Left Island House": LocData(base_id + 30431,
                                                                            LocGroup.VOLLEYBALL_ALT_HARD),
    "Volleyball Flower Cup Alt Path Hard Bottom-Left Island Cannon": LocData(base_id + 30432,
                                                                             LocGroup.VOLLEYBALL_ALT_HARD),
    ...
    "Volleyball Flower Cup Alt Path Hard Below Rightmost Bridge": LocData(base_id + 30438,
                                                                          LocGroup.VOLLEYBALL_ALT_HARD),
    "Volleyball Flower Cup Alt Path Hard Above Rightmost Bridge": LocData(base_id + 30439,
                                                                          LocGroup.VOLLEYBALL_ALT_HARD),
    "Volleyball Flower Cup Alt Path Hard Middle-Right Island Field": LocData(base_id + 30440,
                                                                             LocGroup.VOLLEYBALL_ALT_HARD),
    "Volleyball Flower Cup Alt Path Hard Middle-Right Island Cannon": LocData(base_id + 30441,
                                                                              LocGroup.VOLLEYBALL_ALT_HARD),
    "Volleyball Flower Cup Alt Path Hard Top-Right Island Tower": LocData(base_id + 30442,
                                                                          LocGroup.VOLLEYBALL_ALT_HARD),
    "Volleyball Flower Cup Alt Path Hard Top-Right Island Bottom Field": LocData(base_id + 30443,
                                                                                 LocGroup.VOLLEYBALL_ALT_HARD),
    "Volleyball Flower Cup Alt Path Hard Top-Right Island Right Field": LocData(base_id + 30444,
                                                                                LocGroup.VOLLEYBALL_ALT_HARD),
    ...
    "Volleyball Star Cup Alt Path Hard Star Road Bottom-Left of Star": LocData(base_id + 30510,
                                                                               LocGroup.VOLLEYBALL_ALT_HARD),
    "Volleyball Star Cup Alt Path Hard Star Road Top-Left of Star": LocData(base_id + 30511,
                                                                            LocGroup.VOLLEYBALL_ALT_HARD),
    "Volleyball Star Cup Alt Path Hard Star Road Top-Center of Star": LocData(base_id + 30512,
                                                                              LocGroup.VOLLEYBALL_ALT_HARD),
    "Volleyball Star Cup Alt Path Hard Star Road Top-Right of Star": LocData(base_id + 30513,
                                                                             LocGroup.VOLLEYBALL_ALT_HARD),
    "Volleyball Star Cup Alt Path Hard Star Road Bottom-Right of Star": LocData(base_id + 30514,
                                                                                LocGroup.VOLLEYBALL_ALT_HARD),
}
...
hockey_alternate_path_normal_locations: Dict[str, LocData] = {
    ...
    "Hockey Flower Cup Alt Path Normal Middle-Right Island Cannon": LocData(base_id + 30602,
                                                                            LocGroup.HOCKEY_ALT_NORMAL),
    "Hockey Flower Cup Alt Path Normal Top-Right Island Tower": LocData(base_id + 30603, LocGroup.HOCKEY_ALT_NORMAL),
    "Hockey Flower Cup Alt Path Normal Top-Right Island Bottom Field": LocData(base_id + 30604,
                                                                               LocGroup.HOCKEY_ALT_NORMAL),
    "Hockey Flower Cup Alt Path Normal Top-Right Island Right Field": LocData(base_id + 30605,
                                                                              LocGroup.HOCKEY_ALT_NORMAL),
    ...
    "Hockey Star Cup Alt Path Normal Star Road Bottom-Left of Star": LocData(base_id + 30665,
                                                                             LocGroup.HOCKEY_ALT_NORMAL),
    "Hockey Star Cup Alt Path Normal Star Road Top-Left of Star": LocData(base_id + 30666, LocGroup.HOCKEY_ALT_NORMAL),
    "Hockey Star Cup Alt Path Normal Star Road Top-Center of Star": LocData(base_id + 30667,
                                                                            LocGroup.HOCKEY_ALT_NORMAL),
    "Hockey Star Cup Alt Path Normal Star Road Top-Right of Star": LocData(base_id + 30668, LocGroup.HOCKEY_ALT_NORMAL),
    "Hockey Star Cup Alt Path Normal Star Road Bottom-Right of Star": LocData(base_id + 30669,
                                                                              LocGroup.HOCKEY_ALT_NORMAL),
}
